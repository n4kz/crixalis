...
var Route   = require('./route'),
	...
	plugins = 'request static compression processor coffee less jade shortcuts'.split(' '),
 ...
 * @type Function
 */
define('property', 'handler', Context, { writable: false });
 ...
 *
 *     c.start('http', port, [[hostname], ...])
 *     c.start('https', port, [[hostname], ...])
 *
 * @method start
 * @return {Server}
 */
define('method', 'start', function (type) {
	var server = require(type)
 ...
 * @return {Burrow}
 */
define('method', 'burrow', function () { return new Burrow() });
