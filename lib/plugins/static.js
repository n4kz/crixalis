 ...
 * with extensions. To disable this behaviour pass `route` parameter
 *
 *     // With default route
 *     Crixalis.plugin('static');
 *
 *     // Withoud default route
 *     Crixalis.plugin('static', { route: false });
 *
 * @module Crixalis
 * @submodule static
 * @for Controller
...
module.exports = function (options) {
	 ...
	 * @private
	 */
	Crixalis.define('property', '_symlinks', false);
