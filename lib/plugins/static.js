...
/**
 * Static plugin.
 * Provides basic file-serving capabilities. By default tries to serve all paths
 * with extensions. To disable this behaviour set `route` parameter to `false`
 *
 *     // Default options
 ...
 *         symlinks  : false,
 *
 *         // Cache files and stat calls for 10 seconds
 *         cacheTime : 10000
 *     });
 *
 * @module Crixalis
