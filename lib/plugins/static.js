...
module.exports = function (options) {
	...
	if (options.route) {
		Crixalis.route(/^\/(.+)\.([^.\/]+)$/, {
			...
			var that = this,
				path = normalize(this.staticPath + '/' + this.params.path + '.' + this.params.extension);
			...
			this[typeof this[this.params.extension] === 'function'? extension : 'serve'](path, function (error) {
				that.error(404);
			});
		});
	}
	 ...
	 * @type Object
	 */
	Crixalis.define('property', 'expires', Object.create(null));
