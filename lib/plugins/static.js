...
var controller = require('crixalis'),
	Crixalis   = controller.self,
	fs         = require('fs'),
	zlib       = require('zlib'),
...
function send (stream) {
	...
	if (stream) {
		...
		/* EOF */
		stream.once('end', destroy.bind(this));
	}
}
...
module.exports = function () {
	...
	/* TODO: getter/setter for views */
	controller._views.file = function () {
