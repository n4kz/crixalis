...
/**
 * Request plugin
 * Provides thin wrapper around http.request and https.request methods
 *
 *     var that = this;
 *
 *     this.request({
...
module.exports = function () {
	 ...
	 * @chainable
	 */
	this.define('request', function (options, callback) {
		var request, data;

		/* Protected from multiple calls callback version */
